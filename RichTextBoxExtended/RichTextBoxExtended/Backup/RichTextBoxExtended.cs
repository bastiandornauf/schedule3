...
namespace RichTextBoxExtended
{
	...
	public class RichTextBoxExtended : System.Windows.Forms.UserControl
	{
        ...
        private ToolBarButton tbbColorChoose;
		private System.Windows.Forms.ToolBarButton tbbPaste;

		public RichTextBoxExtended()
		{
			KnownFonts = new List<string>();
            KnownFonts.Add("Arial");
            KnownFonts.Add("Courier New");
            KnownFonts.Add("Garamond");
            KnownFonts.Add("Microsoft Sans Serif");
            KnownFonts.Add("Tahoma");
            KnownFonts.Add("Times New Roman");
            KnownFonts.Add("Verdana");
            
            // This call is required by the Windows.Forms Form Designer.
            this.rtb1 = new RichTextBoxPrintCtrl.RichTextBoxPrintCtrl();
            
            InitializeComponent();
            
            // Generate Font-List/Contextmenu
            GenerateFontMenu();

            // Set Colored Color-Button
            selectedColor = Color.Black;
            ChangeColorButtonAppearance();
        ...
        private RichTextBoxPrintCtrl.RichTextBoxPrintCtrl rtb1;
        ...
        private void InitializeComponent()
		{
            ...
            this.tbbColorChoose = new System.Windows.Forms.ToolBarButton();
            this.SuspendLayout();
            // 
            // tb1
            // 
            ...
            this.imgList1.Images.SetKeyName(21, "Image.gif");
            // 
            // rtb1
            // 
            ...
            // tbbColorChoose
            // 
            this.tbbColorChoose.ImageIndex = 7;
            this.tbbColorChoose.Name = "tbbColorChoose";
            this.tbbColorChoose.Tag = "colorChoose";
            // 
            // RichTextBoxExtended
            // 
        ...
        /// <summary>
        /// A List of usable Font(name)s in the MenuBar of the RTB
        /// </summary>
        public List<string> KnownFonts;
        /// <summary>
        /// Updates the FontMenu, necessary after any Change to KnownFonts
        /// </summary>
        public void UpdateFontMenu()
        {
            GenerateFontMenu();
        }

        private void GenerateFontMenu()
        {
            // 
            // cmFonts
            // 
            ...
            foreach (MenuItem item in cmFonts.MenuItems)
                item.Click -= new System.EventHandler(this.Font_Click);
            this.cmFonts.MenuItems.Clear();

            // Build new MenuItems
            foreach (String fontName in KnownFonts)
            {
            ...
            this.cmFonts.MenuItems.AddRange(menuItems.ToArray());
        }
		#endregion
		...
		private void tb1_ButtonClick(object sender, System.Windows.Forms.ToolBarButtonClickEventArgs e)
		{
			...
			switch(e.Button.Tag.ToString().ToLower())
			{
				...
				case "color":
                    ...
                    Color_Click(sender, new EventArgs());
					break;
				case "undo":
					rtb1.Undo();
					break;
        ...
        private void ChangeColorButtonAppearance()
        {
            int index = tbbColor.ImageIndex;                       
            Image colorButton = imgList1.Images[tbbColor.ImageIndex];

            using (Graphics g = Graphics.FromImage(colorButton))
            {
                RectangleF rect = g.VisibleClipBounds;
                rect.Inflate(-3.0f, -3.0f);
                
                g.FillRectangle(new SolidBrush(selectedColor), rect);
                
                Brush b = (selectedColor == Color.Black) ? (Brushes.White) : (Brushes.Black);                
                Font f = new Font("Arial", 5);
                
                g.DrawString("Ab",f , b, new PointF(1.5f,6f));
            ...
            tbbColor.ImageIndex = index;
            tb1.ImageList = null;
            imgList1.Images[index] = colorButton;
        ...
        public RichTextBoxPrintCtrl.RichTextBoxPrintCtrl PrintableRichTextBox
        {
            get
            {
                return rtb1;
