    ...
    public class Office12Renderer : AbstractRenderer
    {
        ...
        public override Font BaseFont
        {
            get
            {
                if (baseFont == null)
                {
                    baseFont = new Font("Trebuchet MS", 9, FontStyle.Regular);
                }
        ...
        public override Color HourMarkColor
        {
            get
            {
        ...
        public override Color MiddayMarkColor
        {
            get
            {
        ...
        public override void DrawHourLabel(System.Drawing.Graphics g, System.Drawing.Rectangle rect, int hour)
        {
            ...
            using (Pen pen = new Pen(color))
                g.DrawLine(pen, rect.Left, rect.Y, rect.Width + rect.Left, rect.Y);
        ...
        public override void DrawDayHeader(System.Drawing.Graphics g, System.Drawing.Rectangle rect, DateTime date)
        {
            ...
            using (Font fntDay = new Font("Trebuchet MS", 8))
                g.DrawString(sTodaysName, fntDay, SystemBrushes.WindowText, rect, m_Format);

            rect.Offset(-2, -1);

            using (Font fntDayDate = new Font("Trebuchet MS", 9, FontStyle.Bold))
        ...
        public override void DrawAppointment(System.Drawing.Graphics g, System.Drawing.Rectangle rect, DVAppointment appointment, bool isSelected, int gripWidth)
        {
            StringFormat m_Format = new StringFormat();
            ...
            Brush b = new SolidBrush(appointment.TextColor);
            g.DrawString(appointment.Title, this.BaseFont, b, rect, m_Format);
